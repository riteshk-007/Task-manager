...
const Task = () => {
  ...
  return (
    <div
      className={
        !change
          ? "md:w-56 md:h-56 h-32 w-32 cursor-pointer overflow-y-auto no-scrollbar relative bg-black rounded-lg shadow-lg hover:scale-105 transition-all duration-200 flex items-start justify-start flex-col p-2 md:p-3 overflow-hidden"
